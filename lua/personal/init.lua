...
local cache_ok, cache = pcall(require, "core.cacheX")
if cache_ok then
...
local critical_modules = {
  "core.utilX",   -- Utilidades base
  "core.optionX", -- Opciones de Neovim
}

-- Fase 2: ALTA PRIORIDAD (cargan con pequeño delay)
local high_priority_modules = {
  "core.keymapX",  -- Keymaps globales
  "core.autocmdX", -- Autocomandos
}

-- Fase 3: NORMAL (cargan después)
local normal_modules = {
  "core.loaderX", -- Sistema de lazy loading
}
